 ...
 */
public class DufanAnnualPass extends javax.swing.JFrame {
     ...
     */
    public DufanAnnualPass() {
        initComponents();
        id_auto();
        piket.setText("Dufan - AnnualPass");

        // Set the initial value of haket to "30000"
        haket.setText("600000");

        // Add ActionListeners to juket and juken
        juket.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void updateChange(DocumentEvent e) {
                updateSubtotal();
            }
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtnama);
        txtnama.setBounds(540, 100, 300, 30);

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("KEMBALIAN");
        jPanel2.add(jLabel12);
        jLabel12.setBounds(320, 400, 90, 30);
        ...
        jPanel2.add(haket);
        haket.setBounds(540, 220, 300, 30);

        juket.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jPanel2.add(juket);
        juket.setBounds(540, 260, 300, 30);

        txttotal.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txttotal.setEnabled(false);
        jPanel2.add(txttotal);
        txttotal.setBounds(540, 310, 300, 30);
        ...
        jPanel2.add(input);
        input.setBounds(760, 480, 80, 30);
        jPanel2.add(txttanggal);
        txttanggal.setBounds(540, 140, 300, 30);

        piket.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        piket.setEnabled(false);
        jPanel2.add(piket);
        piket.setBounds(540, 180, 300, 30);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(-90, 210, 1090, 540);
    ...
    void insert() {
        try {
            ...
            if (txtnama.getText().isEmpty() || txttanggal.getDate() == null || piket.getText().isEmpty()
                    || haket.getText().isEmpty() || juket.getText().isEmpty() || txttotal.getText().isEmpty()
            ...
            if (bayar < total) {
                ...
                // Do not set the change to 0 when the payment is insufficient
                txtkembali.setText("");  // Set txtkembali to empty when payment is insufficient
                return; // Exit the method if the payment is insufficient
            }

            // Calculate change only when the payment is sufficient
            int kembali = bayar - total;
            ...
            stat.executeUpdate("INSERT INTO t_annualpass (No_Transaksi, Nama, Pilih_Tanggal, Pilh_Tiket, Harga_Tiket, Jumlah_Tiket, SubTotal, Bayar, Kembalian) VALUES ('"
                    + txtno.getText() + "','"
                    + txtnama.getText() + "','"
                    + tanggal + "','"
                    + piket.getText() + "','"
            ...
            TransaksiAnnualPass transaksiAnnualPassFrame = new TransaksiAnnualPass();
            transaksiAnnualPassFrame.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DufanAnnualPass.class
